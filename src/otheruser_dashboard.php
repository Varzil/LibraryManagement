...
td, a{
   ...
   include("data_class.php");
    ?>
           <div class="container">
            <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/logoo.png"width="2200px" height="130px"/></div>
...
<!-- REQUEST BOOK BUTTON -->
            ...
            <th>Book Name</th><th>Book author</th><th>Book Publication</th><th>price</th></th><th>Request Book</th></tr>";
