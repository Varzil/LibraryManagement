...
<html>
    ...
    td, a{
        color:black;
            ...
            /* specifically target the inner and outer spin buttons for number input fields in WebKit-based browsers, such as Safari and Chrome.  */
            ...
            /* focus is a pseudo-class that specifies the styling when an element is in focus. */
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/logoo.png"width="2500px" height="150px"/></div>
